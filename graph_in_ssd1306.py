"""
Class to help make graphics on ssd1306
"""
...
class Graph:
    ...
    def rectangle(self):
        self.oled.hline(self.x_0, self.y_0, self.x_1-self.x_0, 1)
        self.oled.hline(self.x_1, self.y_0, self.x_1-self.x_0, 1)
        self.oled.vline(self.x_0, self.y_0, self.y_1-self.y_0, 1)
        self.oled.vline(self.x_0, self.y_1, self.y_1-self.y_0, 1)
    ...
    def pass_to_graph(self, fill = False):
        ...
        for i in range(len(self.x) - 1):
            self.oled.line(self.x[i], self.y_real[i], self.x[i+1], self.y_real[i+1], 1)
